{ ... }: {
  flake.homeManagerModules.noctalia = { inputs, ... }: {
    imports = [
    ...
    programs.noctalia = {
      ...
      settings = {
        ...
        control_center.shortcuts = [
          ...
          { type = "caffeine"; }
          { type = "nightlight"; }
          { type = "lux/ideapad-conservation-mode:conservation-mode"; }
          { type = "power_profile"; }
        ];
        ...
        plugin_settings = {
          ...
          "damian-ds7/battery-threshold" = {
            battery_device = "/sys/class/power_supply/BAT0/device";
          };
        };
        ...
        theme = {
          ...
          templates = {
            ...
            user.obsidian_extra = {
              ...
              output_path = "/home/vlmsk/ObsidianVault/vlmsk/.obsidian/snippets/noctalia.css";
            };
          };
        };

        wallpaper = {
          directory = "/home/vlmsk/walls";
        };
